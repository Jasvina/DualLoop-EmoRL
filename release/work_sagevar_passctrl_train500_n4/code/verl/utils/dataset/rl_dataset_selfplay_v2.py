...
if _os.environ.get("SIMULATOR_TYPE", "rlver") == "sage":
    from verl.workers.rollout.vllm_rollout.sage_player_simulator_selfplay_v2 import *
else:
...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        simulator_dir = os.path.join(os.environ.get("RLVER_OUTPUT_DIR", "/data/js/DigitalHuman/RLVER/output"), 'simulator')
        ...
        # print("chat",chat)  # removed: too verbose (prints every sample)
...
class VirtualRLHFDataset(RLHFDataset):
    ...
    def __getitem__(self, item):
        ...
        chat = [{"role":"system","content":system_prompt_trained},{"role":"user","content":user_reply["content"]}]
        # print("chat", chat)  # removed: too verbose
