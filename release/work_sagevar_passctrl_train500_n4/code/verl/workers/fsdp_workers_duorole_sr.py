...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self):
        ...
        if self.config.rollout.name == 'hf':
            ...
            #                                    model_hf_config=self.actor_model_config)
                ...
                from verl.workers.rollout.vllm_rollout.vllm_rollout_spmd_duorole_sr import vLLMMultiTurnViaChatRollout_think as vLLMMultiTurnViaChatRolloutDuoRoleSR
                if vllm_mode == 'customized':
    ...
    def init_model(self):
        from verl.workers.actor.dp_actor_duorole_sr import DataParallelPPOActor
