...
class ActorRolloutRefWorker(Worker):
        ...
        if self.config.rollout.name == 'hf':
            ...
            if self.config.rollout.use_fire_sampling:
                ...
                if self.config.thinking:
                    # [V3] Import from V3 rollout file (dual-role self-play)
                    from verl.workers.rollout.vllm_rollout.vllm_rollout_spmd_v3 import vLLMMultiTurnViaChatRollout_think
    ...
    def init_model(self):
        # [V3] Actor uses standard logic (no V3 changes needed - unified advantages)
        from verl.workers.actor.dp_actor_v3 import DataParallelPPOActor
