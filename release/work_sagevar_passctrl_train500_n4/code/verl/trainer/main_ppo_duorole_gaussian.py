...
def main_task(config, compute_score=None):
    ...
    if config.actor_rollout_ref.actor.strategy == 'fsdp':
        ...
        from verl.workers.fsdp_workers_duorole_gaussian import ActorRolloutRefWorker, CriticWorker
    ...
    from verl.trainer.ppo.ray_trainer_duorole_gaussian import ResourcePoolManager, Role
    ...
    if config.reward_model.enable:
        if config.reward_model.strategy == 'fsdp':
            from verl.workers.fsdp_workers_duorole_gaussian import RewardModelWorker
    ...
    if use_environment:
        ...
        from verl.trainer.ppo.ray_trainer_duorole_gaussian import RayPPOTrainer
