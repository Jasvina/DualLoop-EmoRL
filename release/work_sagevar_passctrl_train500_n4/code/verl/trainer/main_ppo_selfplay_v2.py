...
def main_task(config, compute_score=None):
    ...
    if config.actor_rollout_ref.actor.strategy == 'fsdp':
        ...
        from verl.workers.fsdp_workers_selfplay_v2 import ActorRolloutRefWorker, CriticWorker
    ...
    from verl.trainer.ppo.ray_trainer_selfplay_v2 import ResourcePoolManager, Role
    ...
    if use_environment:
        ...
        if config.actor_rollout_ref.thinking:
            ...
            from verl.trainer.ppo.ray_trainer_selfplay_v2 import RayPPOTrainer
